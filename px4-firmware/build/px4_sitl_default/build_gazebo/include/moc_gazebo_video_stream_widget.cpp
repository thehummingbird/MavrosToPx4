...
struct qt_meta_stringdata_gazebo__VideoStreamWidget_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gazebo__VideoStreamWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gazebo__VideoStreamWidget_t qt_meta_stringdata_gazebo__VideoStreamWidget = {
    {
...
QT_MOC_LITERAL(2, 35, 0) // ""
    ...
    "gazebo::VideoStreamWidget\0OnButton\0"
};
...
const QMetaObject gazebo::VideoStreamWidget::staticMetaObject = {
    { &GUIPlugin::staticMetaObject, qt_meta_stringdata_gazebo__VideoStreamWidget.data,
      qt_meta_data_gazebo__VideoStreamWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *gazebo::VideoStreamWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gazebo__VideoStreamWidget.stringdata0))
