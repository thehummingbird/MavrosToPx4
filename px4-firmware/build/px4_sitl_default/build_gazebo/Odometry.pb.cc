...
void Odometry::InternalSwap(Odometry* other) {
  ...
  velocity_covariance_.UnsafeArenaSwap(&other->velocity_covariance_);
...
// required int64 time_usec = 1;
bool Odometry::has_time_usec() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void Odometry::set_has_time_usec() {
  _has_bits_[0] |= 0x00000001u;
}
void Odometry::clear_has_time_usec() {
  _has_bits_[0] &= ~0x00000001u;
}
void Odometry::clear_time_usec() {
  time_usec_ = GOOGLE_LONGLONG(0);
  clear_has_time_usec();
}
 ::google::protobuf::int64 Odometry::time_usec() const {
  // @@protoc_insertion_point(field_get:nav_msgs.msgs.Odometry.time_usec)
  return time_usec_;
}
 void Odometry::set_time_usec(::google::protobuf::int64 value) {
  set_has_time_usec();
  time_usec_ = value;
