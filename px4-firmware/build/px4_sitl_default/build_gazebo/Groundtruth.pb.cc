...
void protobuf_AssignDesc_Groundtruth_2eproto() {
  ...
  static const int Groundtruth_offsets_[11] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Groundtruth, time_usec_),
...
// required int64 time_usec = 1;
bool Groundtruth::has_time_usec() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void Groundtruth::set_has_time_usec() {
  _has_bits_[0] |= 0x00000001u;
}
void Groundtruth::clear_has_time_usec() {
  _has_bits_[0] &= ~0x00000001u;
}
void Groundtruth::clear_time_usec() {
  time_usec_ = GOOGLE_LONGLONG(0);
  clear_has_time_usec();
}
 ::google::protobuf::int64 Groundtruth::time_usec() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.Groundtruth.time_usec)
  return time_usec_;
}
 void Groundtruth::set_time_usec(::google::protobuf::int64 value) {
  set_has_time_usec();
  time_usec_ = value;
