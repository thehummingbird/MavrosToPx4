...
// @@protoc_insertion_point(message_byte_size_start:sensor_msgs.msgs.Imu)
  ...
  if (((_has_bits_[0] & 0x000000d5) ^ 0x000000d5) == 0) {  // All required fields are present.
    // required .gazebo.msgs.Quaternion orientation = 1;
    total_size += 1 +
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        *this->orientation_);
...
// required int64 time_usec = 7;
bool Imu::has_time_usec() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
void Imu::set_has_time_usec() {
  _has_bits_[0] |= 0x00000040u;
}
void Imu::clear_has_time_usec() {
  _has_bits_[0] &= ~0x00000040u;
}
void Imu::clear_time_usec() {
  time_usec_ = GOOGLE_LONGLONG(0);
  clear_has_time_usec();
}
 ::google::protobuf::int64 Imu::time_usec() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.Imu.time_usec)
  return time_usec_;
}
 void Imu::set_time_usec(::google::protobuf::int64 value) {
  set_has_time_usec();
  time_usec_ = value;
...
void Imu::clear_seq() {
 ...
 ::google::protobuf::int64 Imu::seq() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.Imu.seq)
  return seq_;
}
 void Imu::set_seq(::google::protobuf::int64 value) {
  set_has_seq();
  seq_ = value;
