...
if(NOT "include;/usr/include;/home/sharad/catkin_ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/home/sharad/catkin_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sharad/catkin_ws/install/${idir}'.  ${_report}")
    endif()
